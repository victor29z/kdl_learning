...
void init_jointstate_msg(void){

	joint_state.name.resize(7);
	joint_state.position.resize(7);
	joint_state.name[0] = "simple_arm_shoulder_pan_joint";
	joint_state.name[1] = "simple_arm_shoulder_lift_joint";
	joint_state.name[2] = "simple_arm_elbow_joint";
	joint_state.name[3] = "simple_arm_wrist_1_joint";
	joint_state.name[4] = "simple_arm_wrist_2_joint";
	joint_state.name[5] = "simple_arm_wrist_3_joint";
	joint_state.name[6] = "simple_gripper_robotiq_85_left_knuckle_joint";
...
int main(int argc,char** argv){
	...
	bool exit_value; 
	Chain chain; 
	exit_value = my_tree.getChain("world","tool0",chain);
